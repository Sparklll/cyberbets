...
public interface EventResultService {
    ...
    List<Integer> findAllEventResultIdsByEventId(int eventId) throws ServiceException;
    Optional<EventResult> findEventResultById(int eventResultId) throws ServiceException;
    Optional<CoefficientsDto> receiveEventResultCoefficients(int eventResultId) throws ServiceException;
