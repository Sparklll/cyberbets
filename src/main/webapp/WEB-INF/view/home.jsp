    ...
    <div class="row">
        <div class="col-6 col-md-3">
            <div class="discipline" data-discipline="csgo" role="checkbox">
                <img src="static/assets/disciplines/csgo_bg.jpg">
                <div class="discipline-logo-overlay">
                    <img src="static/assets/disciplines/csgo_logo.png">
                </div>
            </div>
        </div>
        <div class="col-6 col-md-3">
            <div class="discipline" data-discipline="dota2" role="checkbox">
                <img src="static/assets/disciplines/dota2_bg.jpg">
                <div class="discipline-logo-overlay">
                    <img src="static/assets/disciplines/dota2_logo.png">
                </div>
            </div>
        </div>
        <div class="col-6 col-md-3 mt-4 mt-md-0">
            <div class="discipline" data-discipline="lol" role="checkbox">
                <img src="static/assets/disciplines/lol_bg.jpg">
                <div class="discipline-logo-overlay">
                    <img src="static/assets/disciplines/lol_logo.png">
                </div>
            </div>
        </div>
        <div class="col-6 col-md-3 mt-4 mt-md-0">
            <div class="discipline" data-discipline="valorant" role="checkbox">
                <img src="static/assets/disciplines/valorant_bg.jpg">
                <div class="discipline-logo-overlay">
                    <img src="static/assets/disciplines/valorant_logo.png">
                </div>
            </div>
        </div>
    </div>
